...
function RcTable({ columns, data, pageCount: controlledPageCount,renderRowSubComponent,fetchData, className,isShowPagination = true }:Props) : React.ReactElement<Props>{
  ...
  return (
    <Fragment>
      <div className={`${className} fragment-box`} {...getTableProps()}>
        <table className={`normal-styles`} {...getTableProps()}>
          <thead>
